...
## Part 1: Hello World App from Scratch (5-6 minutes)
...
### [1:00-1:30] Configure for Hello World App

**Voice-Over:**
*"Now let's configure MakeDev for our new hello world application. I'll use the interactive config generator to set up our project."*

**Command:**
```bash
make config SUBDIR=hello-world-app
```

**Interactive Prompts:**
- Project name: `hello-world-app`
- Git repo: `https://github.com/yourusername/hello-world-app` (or skip for now)
- GCP project ID: `your-gcp-project-id`
- Region: `us-central1` (or your preferred region)

**Voice-Over:**
*"The config generator creates a config.yaml file with all the settings we need. Notice how simple this is—just a few questions and we're ready to go."*

---

### [1:30-3:30] Create Hello World App Locally

**Voice-Over:**
*"Now for the magic—let's create our hello world application from scratch. I'll run `make dev` on a folder that doesn't exist yet, and MakeDev will automatically scaffold a complete React and Node.js application for us."*
...
### [4:00-7:00] Deploy Hello World App to GKE

**Voice-Over:**
*"Now comes the exciting part—deploying to production. With MakeDev, this is just one command: `make deploy`. This single command will provision a GKE cluster, build production Docker images, push them to Google Artifact Registry, deploy to Kubernetes, and configure everything we need for production."*
...
**Commentary Point 5 - GitHub Setup (4:00-4:30):**
...
**Commentary Point 6 - Terraform Cluster Provisioning (4:30-5:30):**
...
**Commentary Point 7 - Docker Image Build (5:30-6:00):**
...
**Commentary Point 8 - Kubernetes Deployment (6:00-6:30):**
...
**Commentary Point 9 - Pods Forming (6:30-7:00):**
...
**Commentary Point 10 - Database Seeding (7:00-7:15):**
...
**Commentary Point 11 - LoadBalancer IP Assignment (7:15-7:30):**
...
To destroy: make destroy SUBDIR=hello-world-app
```
...
**Voice-Over:**
*"There it is—our hello world application, deployed to production, accessible from anywhere on the internet. We went from zero to production in about 7 minutes."*
...
- Show task list with tasks
- Demonstrate CRUD (add a task, mark complete, delete)

**Voice-Over:**
*"There's our task application, running locally. Full authentication, task management, everything working. Now let's deploy this to production."*

---

### [9:00-12:00] Deploy Task App to GKE
...
**Commentary Point 14 - Git Push to Task App Repo (9:00-9:30):**
...
**Commentary Point 15 - Cluster Reuse (9:30-10:00):**
...
**Commentary Point 16 - Production Image Build (10:00-10:30):**
...
**Commentary Point 17 - Kubernetes Namespace (10:30-11:00):**
...
**Commentary Point 18 - Services Deploying (11:00-11:30):**
...
**Commentary Point 19 - Database Seeding (11:30-12:00):**
...
- [ ] Clone MakeDev repo
- [ ] Run `make config SUBDIR=hello-world-app`
- [ ] Run `make dev SUBDIR=hello-world-app`
- [ ] Show app in browser (localhost:3000)
- [ ] Run `make deploy SUBDIR=hello-world-app`
...
### Post-Recording
- [ ] Clean up: `make destroy SUBDIR=hello-world-app`
- [ ] Clean up: `make destroy SUBDIR=task-app`
...
**Key Commands:** 4 commands total (`make config`, `make dev`, `make deploy` × 2)  
**Complexity:** Simple—demonstrates ease of use
